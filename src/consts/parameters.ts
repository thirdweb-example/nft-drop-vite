...
export const contractAddressConst =
  "0x0896Db00D8987Fba2152aa7c14c4255eBC7354cE";
...
export const clientIdConst = import.meta.env.VITE_CLIENT_ID || "";
...
// Change this to `true` if your contract is an open edition contract
export const isOpenEditionConst = false;